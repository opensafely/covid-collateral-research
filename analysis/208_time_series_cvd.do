...
marginsplot
graph export ./output/time_series/margins_cvd_bp_cvd_ethnicity.svg, as(svg) replace
import excel using ./output/time_series/tsreg_tables_cvd.xlsx, sheet (bp_meas_cvd_ethnicity) clear
export delimited using ./output/time_series/tsreg_cvd_bp_cvd_ethnicity.csv, replace